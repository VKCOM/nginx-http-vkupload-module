...
ngx_int_t  ngx_shared_file_write(ngx_shared_file_writer_t *writer, u_char *data, size_t len);
void       ngx_shared_file_writer_close(ngx_shared_file_writer_t *writer);
